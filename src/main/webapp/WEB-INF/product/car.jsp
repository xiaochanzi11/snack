        ...
        <div ng-controller="carCtrl">
            <table>
                ...
                <c:forEach items="${receiptinfo.orderdetailSet}" var="orderdetail">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/sorder/delete?sId=${orderdetail.snackinfo.sId}"
                               class="delete">删除</a>
                        </td>
                    </tr>
                </c:forEach>
            ...
            <div id="carinfo" style="display: none">
                <form id="orderForm" action="${pageContext.request.contextPath}/forder/order" method="post">
                    ...
                    <div class="span24">
                        <p>
                            收货人&nbsp;&nbsp;&nbsp;：<input id="oName" name="oName" type="text" value=""
                                                         style="width:150px"/>
                        ...
                        <p style="text-align:right">
                            <a id="subCarButton">
                                <img src="${pageContext.request.contextPath}/image/finalbutton.gif" width="204"
                                     height="51" border="0"/>
                            </a>
                        </p>
                    </div>
            ...
            <table id="tablePayExample" style="width:100%;display: none;">
                ...
                <tr style="text-align: center;">
                    <td colspan="2"><input type="button" id="comfirPay" value="付款"></td>
                </tr>
            </table>
