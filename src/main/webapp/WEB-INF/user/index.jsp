...
<div class="span11">
    ...
    <div class="weixin">
        ...
        <img id="ewm" style="display:none;" width="200px" maxlength="200px"
        ...
        <div class="topNav clearfix">
            <ul>
                ...
                <li id="headerLogout" class="headerLogout">
                    <a href="${pageContext.request.contextPath}/shop/userlogout">[退出]</a>|
                </li>
                <c:if test="${sessionScope.frontuser!=null}">
...
<div class="container index">
    <div class="span24" style="height: 456px;">
        <img id="hei1" src="${pageContext.request.contextPath}/image/trimImg/hei.png"
             style="display: block;position:absolute;top: 450px;left: 650px;"/>
        <img id="bai1" src="${pageContext.request.contextPath}/image/trimImg/bai.png"
             style="display: none;position:absolute;top: 450px;left: 650px;"/>
        <img id="hei2" src="${pageContext.request.contextPath}/image/trimImg/hei.png"
             style="display: block;position:absolute; top: 450px;left: 750px;"/>
        <img id="bai2" src="${pageContext.request.contextPath}/image/trimImg/bai.png"
             style="display: none;position:absolute;top: 450px;left: 750px;"/>
        <img id="hei3" src="${pageContext.request.contextPath}/image/trimImg/hei.png"
             style="display: block;position:absolute; top: 450px;left: 850px;"/>
        <img id="bai3" src="${pageContext.request.contextPath}/image/trimImg/bai.png"
             style="display: none;position:absolute;top: 450px;left: 850px;"/>
