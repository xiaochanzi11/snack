...
<div>
    ...
    <table>
        ...
        <tr>
            <td>地址:</td>
            <td><input type="text" id="uAddress" name="uAddress" class="text" maxlength="200"
                       value="${userOne.uAddress} "></td>
        </tr>
        <tr>
            <td colspan="2" align="center">
                <button style="margin-top: 10px" id="editbtn">确认修改</button>
            </td>
        </tr>
    </table>
</div>
